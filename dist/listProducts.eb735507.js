...
})({"kJvZR":[function(require,module,exports) {
...
var _productsServices = require("./services/ProductsServices");
var _productsServicesDefault = parcelHelpers.interopDefault(_productsServices);
...
var _getCata = require("./helpers/get_cata");
var _dialog = require("./helpers/dialog");
let img = undefined;
const productServices = new (0, _productsServicesDefault.default)((0, _jsonServerConstantsDefault.default).EndPoint);
$(document).ready(function() {
    ...
    $("#btn-create-product").on("click", ()=>{
        ...
        let pro = new (0, _productDefault.default)(id, name, img, price, quantity, description, categoryId);
...
function deleProduct(id) {
    ...
    productServices.deleteProduct(id).then(()=>{
        let html = (0, _dialog.Dialog)("Oke bro", ()=>{
            location.reload();
        });
...
},{"./services/ProductsServices":"i8l53","./constants/JsonServerConstants":"6L6hL","./models/Product":"b4We3","./helpers/get_cata":"etWGJ","./helpers/dialog":"bK6hi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i8l53":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ProductServices {
    ...
    getAllProducts = async ()=>{
        const res = await (0, _axiosDefault.default).get(this.endPoint + this.collectionName);
        return res.data;
    };
    addProduct = async (product)=>{
        try {
            const res = await (0, _axiosDefault.default).post(this.endPoint + this.collectionName, product);
            return res.data;
        } catch (error) {
    ...
    deleteProduct = async (id)=>{
        try {
            const res = await (0, _axiosDefault.default).delete(this.endPoint + this.collectionName + "/" + id);
        } catch (error) {}
    };
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"etWGJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
